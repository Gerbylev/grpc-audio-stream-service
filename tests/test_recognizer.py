...
async def test_recognize_streaming_with_audio_file(grpc_channel):
    ...
    session_info = stub.CreateSession(pb2.CreateSessionInfo(emails=["gerbylev.oleg@gmail.com"]))

    def request_generator():
        yield pb2.StreamingRequest(options=pb2.StreamingOptions(session_id=session_info.session_id))
    ...
    responses = stub.StreamingAudio(request_generator())
